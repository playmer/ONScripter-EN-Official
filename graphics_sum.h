...
namespace ons_gfx {
    ...
    extern int (*imageFilterMean)(unsigned char *src1, unsigned char *src2, unsigned char *dst, int length);
    extern int (*imageFilterAddTo)(unsigned char *dst, unsigned char *src, int length);
    extern int (*imageFilterSubFrom)(unsigned char *dst, unsigned char *src, int length);
#endif //!BPP16
