...
if (ONSCRIPTER_EN_CI)
    ...
    if (ONSCRIPTER_EN_VCPKG_BUILDTREE)
        ...
        file(TO_CMAKE_PATH ${ONSCRIPTER_EN_VCPKG_BUILDTREE} ONSCRIPTER_EN_VCPKG_BUILDTREE_CMAKE_PATH)
        list(APPEND ONSCRIPTER_EN_VCPKG_ARGS "\"--x-buildtrees-root=${ONSCRIPTER_EN_VCPKG_BUILDTREE_CMAKE_PATH}\"")
    endif()
