...
if (ONSCRIPTER_EN_CI)
    ...
    if (ONSCRIPTER_EN_VCPKG_BUILDTREE)
        ...
        list(APPEND VCPKG_INSTALL_OPTIONS "--x-buildtrees-root=${ONSCRIPTER_EN_VCPKG_BUILDTREE}")
    endif()
    
    if (ONSCRIPTER_EN_VCPKG_PACKAGES)
        set(ONSCRIPTER_EN_VCPKG_PASS_ARGS ON)
        list(APPEND VCPKG_INSTALL_OPTIONS "--x-packages-root=${ONSCRIPTER_EN_VCPKG_PACKAGES}")
    endif()
